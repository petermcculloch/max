...
, 			{
				"box" : 				{
					...
					"id" : "obj-2",
					"fontsize" : 12.0,
					"patching_rect" : [ 386.0, 393.0, 76.0, 20.0 ],
					"numinlets" : 2,
					"patcher" : 					{
						"fileversion" : 1,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"id" : "obj-1",
									"fontsize" : 12.0,
									"patching_rect" : [ 50.0, 26.0, 50.0, 20.0 ],
									"numinlets" : 1
								}
...
, 							{
								"box" : 								{
									...
									"id" : "obj-2",
									"fontsize" : 12.0,
									"patching_rect" : [ 71.0, 82.0, 53.0, 20.0 ],
									"numinlets" : 1
								}
...
, 							{
								"box" : 								{
									...
									"id" : "obj-4",
									"fontsize" : 12.0,
									"patching_rect" : [ 90.0, 119.0, 34.0, 20.0 ],
									"numinlets" : 2
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "float" ],
									"id" : "obj-5",
									"patching_rect" : [ 71.0, 62.0, 15.0, 15.0 ],
									"numinlets" : 0,
									"comment" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 0,
									"id" : "obj-7",
									"patching_rect" : [ 90.0, 146.0, 15.0, 15.0 ],
									"numinlets" : 1,
									"comment" : ""
								}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-3",
					"fontsize" : 12.0,
					"patching_rect" : [ 320.0, 421.0, 143.0, 20.0 ],
					"numinlets" : 3
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-4",
					"fontsize" : 12.0,
					"patching_rect" : [ 153.0, 347.0, 74.0, 20.0 ],
					"numinlets" : 2,
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 20.0, 74.0, 600.0, 426.0 ],
...
, 			{
				"box" : 				{
					...
					"id" : "obj-6",
					"fontsize" : 12.0,
					"patching_rect" : [ 452.0, 205.0, 76.0, 20.0 ],
					"numinlets" : 2
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-10",
					"fontsize" : 12.0,
					"patching_rect" : [ 330.0, 462.0, 199.0, 20.0 ],
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"htextcolor" : [ 0.870588, 0.870588, 0.870588, 1.0 ],
					"triscale" : 0.9,
					"patching_rect" : [ 584.0, 145.0, 55.0, 20.0 ],
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "route center inner outer time",
					"numoutlets" : 5,
					"fontname" : "Arial",
					"outlettype" : [ "", "", "", "", "" ],
					"id" : "obj-18",
					"fontsize" : 12.0,
					"patching_rect" : [ 386.0, 80.0, 274.0, 20.0 ],
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "patcherargs #1 #2 #3 #4 @center @inner @outer @time",
					"numoutlets" : 2,
					"fontname" : "Arial",
					"outlettype" : [ "", "" ],
					"id" : "obj-19",
					"fontsize" : 12.0,
					"patching_rect" : [ 42.0, 49.0, 354.0, 20.0 ],
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-20",
					"fontsize" : 12.0,
					"patching_rect" : [ 621.0, 542.0, 366.0, 34.0 ],
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-21",
					"fontsize" : 12.0,
					"patching_rect" : [ 621.0, 489.0, 257.0, 34.0 ],
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-24",
					"fontsize" : 12.0,
					"patching_rect" : [ 320.0, 492.0, 25.0, 20.0 ],
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-26",
					"fontsize" : 12.0,
					"patching_rect" : [ 89.0, 375.0, 138.0, 20.0 ],
					"numinlets" : 3
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 593.5, 613.0, 382.5, 613.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-3", 0 ],
					"hidden" : 0,
					"midpoints" : [ 98.5, 409.0, 329.5, 409.0 ]
				}
